...
function WhaleCard({w}) {
  return (
    <div style={{borderBottom:"1px solid #0a0d12",padding:"5px 0",display:"flex",alignItems:"center",gap:5}}>
              ...
              {POSITIONS.length===0?(
                ...
                <div key={i} className="mob-card">
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    ...
                    <span style={{fontSize:13,fontWeight:500,color:(p.unrealized_pnl||0)>0?"#00a858":(p.unrealized_pnl||0)<0?"#ff4455":"#8ab8c8"}}>{sign(p.unrealized_pnl||0)}{fmt$(p.unrealized_pnl||0)}</span>
                  </div>
              ...
              <table style={{width:"100%",borderCollapse:"collapse",fontSize:9}}>
                ...
                <tbody>{POSITIONS.map((p,i)=>{
                  ...
                  return(<tr key={i} className="rh" style={{borderBottom:"1px solid #07080b"}}>
                    ...
                    <td style={{padding:"8px",color:(p.unrealized_pnl||0)>0?"#00a858":(p.unrealized_pnl||0)<0?"#ff4455":"#8ab8c8",fontWeight:500,whiteSpace:"nowrap"}}>{sign(p.unrealized_pnl||0)}{fmt$(p.unrealized_pnl||0)}</td>
